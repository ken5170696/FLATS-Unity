...
public class CullArea : MonoBehaviour
{
	...
	{
		FIRST_GROUP_ID = 1;
		SUBDIVISION_FIRST_LEVEL_ORDER = new int[4] { 0, 1, 1, 1 };
		SUBDIVISION_SECOND_LEVEL_ORDER = new int[8] { 0, 2, 1, 2, 0, 2, 1, 2 };
		SUBDIVISION_THIRD_LEVEL_ORDER = new int[12]
		{
			0, 3, 2, 3, 1, 3, 2, 3, 1, 3,
			2, 3
		};
		Size = new Vector2(25f, 25f);
		Subdivisions = new Vector2[3];
		YIsUpAxis = true;
