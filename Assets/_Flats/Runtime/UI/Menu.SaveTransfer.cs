...
public partial class Menu
{
    ...
    void InitializeSaveTransfer()
    {
        ...
        saveTransferPreview = ui.Text("Preview", saveTransferDialog.transform, "", 0, 10, 435, 94, 17);
        ui.Button("ConfirmImport", saveTransferDialog.transform, "Replace current save", 113, -82, 215, 42, ConfirmSaveImport, ModCenterWidgets.Accent);
        ui.Button("CancelImport", saveTransferDialog.transform, "Cancel", -113, -82, 215, 42, () =>
    ...
    void ShowSaveImport()
    {
        ...
        catch (Exception e) { pendingSaveImport = null; saveTransferNotice.text = "Import failed: " + e.Message; }
    }

    void ConfirmSaveImport()
    {
        if (pendingSaveImport == null) return;
        try
        {
