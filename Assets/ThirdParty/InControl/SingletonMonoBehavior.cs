...
namespace InControl
{
	public abstract class SingletonMonoBehavior<T, P> : MonoBehaviour where T : MonoBehaviour where P : MonoBehaviour
	{
		...
		private static void CreateInstance()
		{
			...
			if ((object)typeof(P) == typeof(MonoBehaviour))
			{
		...
		private static T GetInstance()
		{
			lock (lockObject)
			{
				...
				SingletonPrefabAttribute customAttribute = (SingletonPrefabAttribute)Attribute.GetCustomAttribute(typeFromHandle, typeof(SingletonPrefabAttribute));
				...
				else
				{
					...
					GameObject gameObject = UnityEngine.Object.Instantiate(Resources.Load<GameObject>(text)) as GameObject;
					if (gameObject == null)
					{
