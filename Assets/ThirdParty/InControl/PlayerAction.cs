...
namespace InControl
{
	public class PlayerAction : OneAxisInputControl
	{
		...
		private List<BindingSource> defaultBindings;

		private List<BindingSource> regularBindings;

		private List<BindingSource> visibleBindings;
		...
		{
			defaultBindings = new List<BindingSource>();
			regularBindings = new List<BindingSource>();
			visibleBindings = new List<BindingSource>();
