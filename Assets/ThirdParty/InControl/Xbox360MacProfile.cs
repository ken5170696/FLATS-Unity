...
namespace InControl
{
	...
	public class Xbox360MacProfile : UnityInputDeviceProfile
	{
		public Xbox360MacProfile()
		{
			...
			JoystickNames = new string[6] { "", "Microsoft Wireless 360 Controller", "Mad Catz, Inc. Mad Catz FPS Pro GamePad", "Mad Catz, Inc. MadCatz Call of Duty GamePad", "©Microsoft Corporation Controller", "©Microsoft Corporation Xbox Original Wired Controller" };
			LastResortRegex = "360";
