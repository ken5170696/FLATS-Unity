...
namespace InControl
{
	...
	public class TouchSprite 
	{
		...
		[SerializeField]
		protected Sprite busySprite;

		[SerializeField]
		protected Color idleColor;

		[SerializeField]
		protected Color busyColor;

		[SerializeField]
		protected TouchSpriteShape shape;

		[SerializeField]
		protected TouchUnitType sizeUnitType;
		...
		public TouchSprite()
		{
			idleColor = new Color(1f, 1f, 1f, 0.5f);
			busyColor = new Color(1f, 1f, 1f, 1f);
