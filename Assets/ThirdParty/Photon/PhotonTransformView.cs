...
{
	[SerializeField]
	protected PhotonTransformViewPositionModel m_PositionModel;

	[SerializeField]
	protected PhotonTransformViewRotationModel m_RotationModel;

	[SerializeField]
	protected PhotonTransformViewScaleModel m_ScaleModel;
