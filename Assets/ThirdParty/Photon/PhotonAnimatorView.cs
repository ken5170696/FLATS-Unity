...
public class PhotonAnimatorView : MonoBehaviour, IPunObservable
{
	...
	[SerializeField]
	[HideInInspector]
	protected bool ShowLayerWeightsInspector;

	[HideInInspector]
	[SerializeField]
	protected bool ShowParameterInspector;

	[SerializeField]
	[HideInInspector]
	protected List<SynchronizedParameter> m_SynchronizeParameters;

	[HideInInspector]
	[SerializeField]
	protected List<SynchronizedLayer> m_SynchronizeLayers;
	...
	{
		ShowLayerWeightsInspector = true;
		ShowParameterInspector = true;
		m_SynchronizeParameters = new List<SynchronizedParameter>();
		m_SynchronizeLayers = new List<SynchronizedLayer>();
		m_WasSynchronizeTypeChanged = true;
		m_raisedDiscreteTriggersCache = new List<string>();
