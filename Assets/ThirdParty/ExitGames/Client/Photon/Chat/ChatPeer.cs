	...
	public class ChatPeer : PhotonPeer
	{
		...
		private string GetNameServerAddress()
		{
			...
			case ConnectionProtocol.Tcp:
				return string.Format("{0}:{1}", new object[2] { "ns.exitgames.com", value });
			case ConnectionProtocol.WebSocket:
				return string.Format("ws://{0}:{1}", new object[2] { "ns.exitgames.com", value });
			case ConnectionProtocol.WebSocketSecure:
				return string.Format("wss://{0}:{1}", new object[2] { "ns.exitgames.com", value });
			default:
