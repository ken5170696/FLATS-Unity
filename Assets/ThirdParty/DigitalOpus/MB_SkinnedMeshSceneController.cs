...
public class MB_SkinnedMeshSceneController : MonoBehaviour
{
	...
	private void Start()
	{
		GameObject gameObject = (GameObject)UnityEngine.Object.Instantiate(workerPrefab);
	...
	private void OnGUI()
	{
		if (GUILayout.Button("Add/Remove Sword"))
		{
			if (swordInstance == null)
			{
				...
				swordInstance = (GameObject)UnityEngine.Object.Instantiate(swordPrefab);
		...
		if (GUILayout.Button("Add/Remove Hat"))
		{
			if (hatInstance == null)
			{
				...
				hatInstance = (GameObject)UnityEngine.Object.Instantiate(hatPrefab);
		...
		if (GUILayout.Button("Add/Remove Glasses"))
		{
			if (glassesInstance == null)
			{
				...
				glassesInstance = (GameObject)UnityEngine.Object.Instantiate(glassesPrefab);
