...
namespace DigitalOpus.MB.Core
{
	...
	public abstract class MB3_MeshCombiner 
	{
		...
		{
			_LOG_LEVEL = MB2_LogLevel.info;
			_validationLevel = MB2_ValidationLevel.robust;
			_lightmapOption = MB2_LightmapOptions.ignore_UV2;
			_doNorm = true;
			_doTan = true;
			_doUV = true;
			_optimizeAfterBake = true;
			uv2UnwrappingParamsHardAngle = 60f;
			uv2UnwrappingParamsPackMargin = 0.005f;
