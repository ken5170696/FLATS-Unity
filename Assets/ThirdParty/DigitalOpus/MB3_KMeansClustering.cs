...
public class MB3_KMeansClustering
{
	...
	{
		_normalizedDataToCluster = new List<DataPoint>();
		_clusters = new Vector3[0];
		...
		for (int i = 0; i < gos.Count; i++)
		{
			...
			{
				Debug.LogWarning(string.Format("Object {0} in list of objects to cluster was null.", new object[1] { i }));
			}
		}
		if (numClusters <= 0)
		{
