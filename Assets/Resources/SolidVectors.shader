...
sampler2D _MainTex;float4 _MainTex_ST;float _Cutoff;float4x4 _AM_MATRIX_PREV_MVP;
 ...
 MotionVaryings vert(MotionInput v){MotionVaryings o;o.pos=UnityObjectToClipPos(v.vertex);o.current=o.pos;o.previous=mul(_AM_MATRIX_PREV_MVP,v.vertex);o.uv=TRANSFORM_TEX(v.uv,_MainTex);return o;}
